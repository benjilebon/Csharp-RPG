...
namespace RPG
{
    class ItemsData
    {
        static List<Item> items = new List<Item> {
            ...
            new Item(2, 2, 8, 1, "Armure d'étoffe", "Une armure en métal pour encaisser les dégats", 25),
            ...
            new Item(5, 2, 15, 2, "Cotte de mailles", "Une armure lourde pour parer un nombre conséquents de dégats", 45),
            ...
            new Item(8, 2, 30, 3, "Cotte épineuse", "Puissante armure contre les plus gros adversaires", 75),
            ...
            new Item(11, 3, 60, 4, "Soif de Sang", "Épée maudite capable de trancher toute matière", 75),
        };
